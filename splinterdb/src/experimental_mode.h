...
typedef uint32 txn_timestamp;
   ...
   || EXPERIMENTAL_MODE_MVCC_SKETCH_LAZY
...
check_experimental_mode_is_valid()
{
   platform_assert(
      EXPERIMENTAL_MODE_TICTOC_DISK + EXPERIMENTAL_MODE_TICTOC_DISK_CACHE
         ...
         + EXPERIMENTAL_MODE_STO_MEMORY + EXPERIMENTAL_MODE_STO_COUNTER
         + EXPERIMENTAL_MODE_STO_COUNTER_LAZY + EXPERIMENTAL_MODE_STO_SKETCH
         + EXPERIMENTAL_MODE_STO_SKETCH_LAZY + EXPERIMENTAL_MODE_MVCC_DISK
         + EXPERIMENTAL_MODE_MVCC_MEMORY + EXPERIMENTAL_MODE_MVCC_COUNTER
         + EXPERIMENTAL_MODE_MVCC_COUNTER_LAZY + EXPERIMENTAL_MODE_MVCC_SKETCH
         + EXPERIMENTAL_MODE_MVCC_SKETCH_LAZY + EXPERIMENTAL_MODE_2PL_NO_WAIT
         + EXPERIMENTAL_MODE_2PL_WAIT_DIE + EXPERIMENTAL_MODE_2PL_WOUND_WAIT
         + EXPERIMENTAL_MODE_KR_OCC + EXPERIMENTAL_MODE_KR_OCC_PARALLEL
         + EXPERIMENTAL_MODE_SILO_MEMORY
      == 1);
}
